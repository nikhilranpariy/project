			...
			<div class="container">
				...
				<div class="row">
					...
					<?php 
								...
								// Check if 'p' is set in the URL query string
								if (isset($_GET['p']) && !empty($_GET['p'])) {
									$product_id = intval($_GET['p']); // Ensure the product_id is an integer
				...
				<div class="row">
					...
					?>
						...
						if (isset($_GET['p']) && is_numeric($_GET['p'])) {
							...
							// Prepare the SQL statement with a parameterized query
							$product_query = "SELECT * FROM products, categories WHERE product_cat = cat_id AND product_id BETWEEN ? AND ?";
							...
							// Bind parameters (both integers in this case)
							$upper_bound = $product_id + 3;
							$stmt->bind_param("ii", $product_id, $upper_bound);
